...
import com.example.yumfood.GoFoodDatabase;
import com.example.yumfood.R;
...
public class SellerOrderDetailActivity extends AppCompatActivity {
    ...
    private void initUi()
    {
        tvCustomerName = (TextView) findViewById(R.id.activity_seller_order_detail_tv_customer_name);
        rcvProductList = (RecyclerView) findViewById(R.id.activity_seller_order_detail_rcvOrder) ;
        tvTotal = (TextView) findViewById(R.id.activity_seller_order_detail_tv_total);
        tvCountProduct = (TextView) findViewById(R.id.activity_seller_order_detail_tv_count_product);
        tvOrderId = (TextView) findViewById(R.id.activity_seller_order_detail_tv_order_id);
        ivBtnBack = (ImageView) findViewById(R.id.activity_seller_order_detail_iv_btn_back);
        btnAccept = (Button)findViewById(R.id.activity_seller_order_detail_btn_accept) ;
        btnReject  = (Button) findViewById(R.id.activity_seller_order_detail_btn_reject);

        tvOrderDate =  (TextView) findViewById(R.id.activity_seller_order_detail_tv_order_date);
        tvOrderStatus = (TextView) findViewById(R.id.activity_seller_order_detail_tv_oder_status);
        tvReceiver = (TextView) findViewById(R.id.activity_seller_order_detail_receiver);
        tvReceiverPhone = (TextView) findViewById(R.id.activity_seller_order_detail_tv_phone);
        tvShippingAddress = (TextView) findViewById(R.id.activity_seller_order_detail_tv_shipping_address);
        tvStoreName = (TextView) findViewById(R.id.activity_seller_order_detail_tv_store_name);
        tvStoreAddress = (TextView) findViewById(R.id.activity_seller_order_detail_tv_store_address);
        ckbDoorDelivery = (CheckBox) findViewById(R.id.activity_seller_order_detail_ckb_door_delivery);
        ckbTakeEatingUtensils = (CheckBox) findViewById(R.id.activity_seller_order_detail_ckb_take_eating_utensils);
        tvShipFee =  (TextView) findViewById(R.id.activity_seller_order_detail_tv_shipping_fee);
        tvShipperName = (TextView) findViewById(R.id.activity_seller_order_detail_tv_shipper_name);
        tvShipperPhone = (TextView) findViewById(R.id.activity_seller_order_detail_tv_shipper_phone);
        tvApplyFee = (TextView) findViewById(R.id.activity_seller_order_detail_tv_apply_fee);
        tvShipper  = (TextView) findViewById(R.id.activity_seller_order_detail_tv_shipper);
        tv16 =  (TextView) findViewById(R.id.activity_seller_order_detail_tv_16);
        tvSubTotal =  (TextView) findViewById(R.id.activity_seller_order_detail_tv_sub_total);
        tvDistance = (TextView) findViewById(R.id.activity_seller_order_detail_tv_tv_distance);
//        tvChangeOrderStatus = (TextView) findViewById(R.id.activity_seller_order_detail_tv_change_order_status);
...
//        tvChangeOrderStatus.setText(order.getOrderStatus());
        ...
        adapter = new ProductForMerchantOrderDetailAdapter( order.getOrderDetail(), SellerOrderDetailActivity.this);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.SellerOrderDetailActivity);
