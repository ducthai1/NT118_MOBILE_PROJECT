...
public class ProductForMerchantOrderDetailAdapter extends RecyclerView.Adapter<ProductForMerchantOrderDetailAdapter.ProductForMerchantOrderDetailViewHolder>{
    ...
    public ProductForMerchantOrderDetailViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new ProductForMerchantOrderDetailViewHolder(view);
    }
    ...
    public class ProductForMerchantOrderDetailViewHolder extends RecyclerView.ViewHolder{
        ...
        public ProductForMerchantOrderDetailViewHolder(@NonNull View itemView) {
            super(itemView);
            tvProductName = itemView.findViewById(R.id.item_product_for_seller_order_detail_tv_product_name);
            tvQuantity = itemView.findViewById(R.id.item_product_for_seller_order_detail_tv_quantity);
            tvPrice = itemView.findViewById(R.id.item_product_for_seller_order_detail_tv_unit_price);
            tvTopping = itemView.findViewById(R.id.item_product_for_seller_order_detail_tv_topping);
        }
    }
}
